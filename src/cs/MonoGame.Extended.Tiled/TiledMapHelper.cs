...
namespace MonoGame.Extended.Tiled
{
    public static class TiledMapHelper
    {
        ...
        public static Rectangle GetTileSourceRectangle(int localTileIdentifier, int tileWidth, int tileHeight, int columns, int margin, int spacing)
        {
        ...
        public static Point2 GetOrthogonalPosition(int tileX, int tileY, int tileWidth, int tileHeight)
        {
        ...
        public static Point2 GetIsometricPosition(int tileX, int tileY, int tileWidth, int tileHeight)
        {
